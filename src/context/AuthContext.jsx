...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ user, userRole, isBrandAdmin, isAccounting, loading, subscription, signUp, signIn, signInWithProvider, resetPassword, verifyResetCode, signOut, updateEmail, updatePassword, updateAvatar, updateProfile, refreshSubscription }}>
      {children}
